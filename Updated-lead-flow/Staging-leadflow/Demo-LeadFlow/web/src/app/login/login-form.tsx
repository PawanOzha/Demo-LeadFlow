      ...
      <label className="block text-sm font-medium text-lf-text-secondary">
        ...
        <div className="relative mt-2">
          <input
            ...
            className="min-h-10 w-full rounded-md border border-lf-border bg-lf-surface px-3 py-2 pr-12 text-sm text-lf-text outline-none placeholder:text-lf-subtle focus:border-lf-brand focus:ring-2 focus:ring-lf-brand/20 focus:ring-offset-2 focus:ring-offset-lf-surface"
          />
          <button
            type="button"
