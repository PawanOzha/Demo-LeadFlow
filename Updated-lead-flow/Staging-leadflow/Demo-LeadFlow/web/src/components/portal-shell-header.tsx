...
export function PortalShellHeader({
  ...
  pageTitle?: string;
  /** Optional leading controls (e.g. sidebar collapse toggle). */
  ...
  return (
    <header className="sticky top-0 z-20 w-full shrink-0 border-b border-lf-border/60 bg-lf-header/95 backdrop-blur-sm">
      <div className="mx-auto flex h-16 min-h-16 max-w-[1440px] items-center justify-between gap-3 px-4 sm:px-6">
        {logoRight ? (
          <>
            {userCluster}
            {brandLink}
