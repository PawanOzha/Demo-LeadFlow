    ...
    >
      ...
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          autoComplete="off"
          enterKeyHint="search"
          className="h-9 w-full rounded-lg border border-lf-border bg-lf-bg/80 pl-9 pr-4 text-[13px] text-lf-text placeholder:text-lf-muted outline-none transition-all focus:border-transparent focus:bg-lf-surface focus:ring-2 focus:ring-lf-brand sm:w-64"
        />
      </div>
      {value.trim() ? (
        <button
